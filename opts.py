...
def parse_opt():
    ...
    parser.add_argument('--clipped_lambda', type=float, default=1, ## Added
                    help='The parameter to set the weight of the clipped ratio policy')
    parser.add_argument('--sc_lambda', type=float, default=0, ## Added
                    help='The parameter to set the weight of the self-critical policy')
